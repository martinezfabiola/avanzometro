...
class Cursa(models.Model):
    carnet = models.ForeignKey('Estudiante', models.DO_NOTHING, db_column='carnet', primary_key=True)
    codasig = models.ForeignKey(Asignatura, models.DO_NOTHING, db_column='codasig')
